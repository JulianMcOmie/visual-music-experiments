...
export default function PenroseTiling() {
  ...
  const [keyframes, setKeyframes] = useState<Keyframe[]>([
    {
      ...
      settings: {
        ...
        angleOffset: 0,
        delayModeParam: 1.25,
        delayFunctionPower: 1,
        rotationOscEnabled: false,
        hueOscEnabled: false,
        layerOscEnabled: false,
        timeDelayOscEnabled: false,
        angleOffsetOscEnabled: false,
        delayModeParamOscEnabled: false,
        delayFunctionPowerOscEnabled: false,
        tileRotationOscEnabled: false,
        tileSpreadOscEnabled: false,
      }
    },
    {
      id: "setting-8",
    ...
    },
    {
      ...
      settings: {
        ...
        layerOscEnabled: false,
        timeDelayOscEnabled: false,
        angleOffsetOscEnabled: true,
        delayModeParamOscEnabled: false,
        delayFunctionPowerOscEnabled: false,
        tileRotationOscEnabled: true,
        tileSpreadOscEnabled: false,
      }
    },
    {
  ...
  const [timelineDuration, setTimelineDuration] = useState(105); // 105 seconds default
